...
The **flows** domain ([`crates/openhuman-core/src/openhuman/flows/`](../../../crates/openhuman-core/src/openhuman/flows/)) drives
...
| `tinyagents`                  | The published state-graph + agent-loop harness both runtimes lower onto.                                                                        | crate; OpenHuman seam in [`crates/openhuman-core/src/openhuman/agent/tinyagents/`](../../../crates/openhuman-core/src/openhuman/agent/tinyagents/) |
| `openhuman::flows`            | The host: CRUD/run/resume RPCs, SQLite store, triggers, the builder/scout agents.                                                               | [`crates/openhuman-core/src/openhuman/flows/`](../../../crates/openhuman-core/src/openhuman/flows/)                                                |
| `openhuman::flows::tinyflows` | The **capability seam** - adapters implementing the `tinyflows` traits over real OpenHuman services.                                            | [`crates/openhuman-core/src/openhuman/flows/tinyflows/`](../../../crates/openhuman-core/src/openhuman/flows/tinyflows/)                            |
...
3. **run** ([`engine.rs`](../../../vendor/tinyflows/src/engine.rs)) - the host
   ...
   ([`flows/ops.rs`](../../../crates/openhuman-core/src/openhuman/flows/ops.rs), `flows_run`), which
...
4. **outcome** - a `RunOutcome { output, pending_approvals, cancelled }`; the host
   ...
   ([`tinyflows/langfuse_export.rs`](../../../crates/openhuman-core/src/openhuman/flows/tinyflows/langfuse_export.rs)).
...
([`caps.rs`](../../../crates/openhuman-core/src/openhuman/flows/tinyflows/caps.rs), `open_flow_checkpointer`).
...
([`caps.rs`](../../../crates/openhuman-core/src/openhuman/flows/tinyflows/caps.rs)):
...
- **A harness `AgentDefinition` exists** → build a full harness `Agent`
  ...
  ([`crates/openhuman-core/src/openhuman/agent/tinyagents/mod.rs`](../../../crates/openhuman-core/src/openhuman/agent/tinyagents/mod.rs)) -
...
([`flows/ops.rs`](../../../crates/openhuman-core/src/openhuman/flows/ops.rs), via
...
`FlowTriggerSubscriber` ([`flows/bus.rs`](../../../crates/openhuman-core/src/openhuman/flows/bus.rs)) is
...
| --------------------- | -------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Builder** (copilot) | `workflow_builder`   | `flows_build` ([`ops.rs`](../../../crates/openhuman-core/src/openhuman/flows/ops.rs))    | `propose_workflow` / `revise_workflow` (validate-only), `dry_run_workflow` (compile + run vs. mocks), `save_workflow`, `run_workflow`, catalog/connection reads ([`builder_tools.rs`](../../../crates/openhuman-core/src/openhuman/flows/builder_tools.rs)) |
| **Scout** (discovery) | `flow_discovery`     | `flows_discover` ([`ops.rs`](../../../crates/openhuman-core/src/openhuman/flows/ops.rs)) | `suggest_workflows` ([`discovery_tools.rs`](../../../crates/openhuman-core/src/openhuman/flows/discovery_tools.rs))                                                                                                                                         |
| **Executor**          | _(n/a - the engine)_ | `flows_run` / `flows_resume`                                       | the capability seam above                                                                                                                                                                                                             |

Both agents live under
[`crates/openhuman-core/src/openhuman/flows/agents/`](../../../crates/openhuman-core/src/openhuman/flows/agents/) as
...
| [`crates/openhuman-core/src/openhuman/flows/tinyflows/caps.rs`](../../../crates/openhuman-core/src/openhuman/flows/tinyflows/caps.rs)                       | The host adapters, `build_capabilities`, `open_flow_checkpointer`, the two-layer gate helpers. |
| [`crates/openhuman-core/src/openhuman/flows/ops.rs`](../../../crates/openhuman-core/src/openhuman/flows/ops.rs)                                             | `flows_run` / `flows_resume` / `flows_build` / `flows_discover` and CRUD.                      |
| [`crates/openhuman-core/src/openhuman/flows/bus.rs`](../../../crates/openhuman-core/src/openhuman/flows/bus.rs)                                             | `FlowTriggerSubscriber` - the host-side multi-trigger bridge.                                  |
| [`crates/openhuman-core/src/openhuman/flows/builder_tools.rs`](../../../crates/openhuman-core/src/openhuman/flows/builder_tools.rs)                         | The builder's `propose` / `revise` / `dry_run` / `save` / `run` tools.                         |
| [`crates/openhuman-core/src/openhuman/flows/agents/`](../../../crates/openhuman-core/src/openhuman/flows/agents/)                                           | `workflow_builder` + `flow_discovery` agent definitions.                                       |
| [`crates/openhuman-core/src/openhuman/flows/tinyflows/langfuse_export.rs`](../../../crates/openhuman-core/src/openhuman/flows/tinyflows/langfuse_export.rs) | Post-run export of the durable graph observations.                                             |

## See also

- [Agent Harness](agent-harness.md) - the tinyagents turn every `agent` node (and
  the builder/scout) runs on.
- [Security (`crates/openhuman-core/src/openhuman/security/`)](security.md) - the `SecurityPolicy` /
