...
Confidentiality and integrity live entirely on the two endpoints. The exact primitives, from `crates/openhuman-core/src/openhuman/security/devices/crypto.rs`:
