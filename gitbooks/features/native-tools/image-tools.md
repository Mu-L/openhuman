...
The contract lives in the top-level `crates/openhuman-core/src/openhuman/media/image/` module and
...
`crates/openhuman-core/src/openhuman/media/generation/` domain ships **wired, executing** tools that
