...
```rust
// crates/openhuman-core/src/openhuman/providers/router.rs
...
- **Globally**. config TOML (`Config` struct in `crates/openhuman-core/src/openhuman/config/schema/types.rs`) can supply a custom route table at startup.
