...
use super::*;
use crate::agent::triage::envelope::TriggerEnvelope;
...
fn every_dispatch_site_scopes_an_origin() {
    const KNOWN_SITES: &[(&str, &str)] = &[
        ...
        ("crates/openhuman-core/src/skills/webhooks/ops.rs", "remote"),
        ("crates/openhuman-core/src/skills/webhooks/bus.rs", "remote"),
        // Locally initiated — trust root.
        (
            "crates/openhuman-core/src/desktop/notifications/rpc.rs",
            "local",
        ),
        ("crates/openhuman-core/src/agent/schemas.rs", "local"),
    ];
    ...
    while let Some(dir) = stack.pop() {
        ...
        for entry in entries.flatten() {
            ...
            // being them.
            if rel.starts_with("crates/openhuman-core/src/agent/triage/")
