...
//! config, and [`SecurityPolicy`](crate::security::SecurityPolicy)
...
//! * [`SecurityPolicy::is_within_trusted_root`](crate::security::SecurityPolicy::is_within_trusted_root),
...
//! [`TrustedRoot`](crate::security::TrustedRoot) with
...
//! ([`SecurityPolicy::is_always_forbidden`](crate::security::SecurityPolicy::is_always_forbidden))
