...
pub struct Flow {
    ...
    /// was triggered. See `crates/openhuman-core/src/security/approval/gate.rs` and
    /// `crates/openhuman-core/src/agent/turn_origin.rs::TrustedAutomationSource::Workflow`.
    #[serde(default)]
    pub require_approval: bool,
}
