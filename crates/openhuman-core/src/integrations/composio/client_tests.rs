...
fn config_with_session_token(tmp: &tempfile::TempDir) -> crate::config::Config {
...
fn direct_tool_for_test() -> std::sync::Arc<crate::tools::ComposioTool> {
    std::sync::Arc::new(crate::tools::ComposioTool::new(
        "ck_test_direct",
        Some("default"),
...
fn direct_tool_for_mock(base_v3: String) -> std::sync::Arc<crate::tools::ComposioTool> {
...
fn direct_tool_for_mock_with_key(
    base_v3: String,
    api_key: &str,
) -> std::sync::Arc<crate::tools::ComposioTool> {
    std::sync::Arc::new(crate::tools::ComposioTool::new_with_v3_base(
        api_key,
        Some("default"),
        std::sync::Arc::new(crate::security::SecurityPolicy::default()),
        base_v3,
...
impl DirectAuthFailureGuard {
    fn for_tool(tool: &std::sync::Arc<crate::tools::ComposioTool>) -> Self {
