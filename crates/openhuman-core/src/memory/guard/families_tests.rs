...
use crate::memory::guard::test_support::{document, embedded_policy, external_policy, guarded};
...
fn episodic_turn(content: &str) -> crate::memory::api::provider::EpisodicTurn {
    crate::memory::api::provider::EpisodicTurn {
        id: None,
...
fn episodic_event(content: &str) -> crate::memory::api::provider::EpisodicEvent {
    crate::memory::api::provider::EpisodicEvent {
        event_id: "event-1".into(),
        segment_id: "segment-1".into(),
        session_id: "session-1".into(),
        namespace: "ns".into(),
        kind: crate::memory::api::provider::EventKind::Fact,
        content: content.into(),
        subject: None,
        timestamp_ref: None,
        confidence: 1.0,
...
fn summary_context() -> crate::memory::api::provider::content::SummaryContext {
    crate::memory::api::provider::content::SummaryContext {
...
fn summary_input(content: &str) -> crate::memory::api::provider::content::SummaryInput {
    let at = chrono::Utc::now();
    crate::memory::api::provider::content::SummaryInput {
        id: "turn-1".into(),
        content: content.into(),
        token_count: 4,
        entities: Vec::new(),
...
async fn guard_admits_a_backfill_dry_run_at_readonly_but_refuses_the_executing_pass() {
    use crate::memory::api::provider::types::BackfillTreesRequest;
