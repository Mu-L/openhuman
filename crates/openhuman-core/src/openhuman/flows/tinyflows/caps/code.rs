...
/// `crates/openhuman-core/src/openhuman/sandbox/ops.rs` (`resolve_sandbox_policy` +
/// `execute_in_sandbox`), modeled on
/// `crates/openhuman-core/src/openhuman/tools/impl/system/node_exec.rs::run_sandboxed`.
///
