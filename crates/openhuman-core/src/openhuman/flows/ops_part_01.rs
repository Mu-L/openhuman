...
/// 10-minute fail-closed TTL (`crates/openhuman-core/src/openhuman/security/approval/`), so a flow HITL gate a
...
// (`crates/openhuman-core/src/openhuman/security/`) the agent tool-loop honors, built via
...
// (`crates/openhuman-core/src/openhuman/flows/tinyflows/caps.rs::enforce_node_tier_gate`) maps the node to a
