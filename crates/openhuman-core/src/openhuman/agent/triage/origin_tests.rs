...
fn every_dispatch_site_scopes_an_origin() {
    const KNOWN_SITES: &[(&str, &str)] = &[
        ...
        (
            "crates/openhuman-core/src/openhuman/memory/sync/composio/bus_part_01.rs",
            "remote",
        ),
        (
            "crates/openhuman-core/src/openhuman/integrations/task_sources/route.rs",
            "remote",
        ),
        (
            "crates/openhuman-core/src/openhuman/skills/webhooks/ops.rs",
            "remote",
        ),
        (
            "crates/openhuman-core/src/openhuman/skills/webhooks/bus.rs",
            "remote",
        ),
        // Locally initiated — trust root.
        (
            "crates/openhuman-core/src/openhuman/desktop/notifications/rpc.rs",
            "local",
        ),
        (
            "crates/openhuman-core/src/openhuman/agent/schemas.rs",
            "local",
        ),
    ];
    ...
    let mut stack = vec![root.join("crates/openhuman-core/src")];
    while let Some(dir) = stack.pop() {
        ...
        for entry in entries.flatten() {
            ...
            // being them.
            if rel.starts_with("crates/openhuman-core/src/openhuman/agent/triage/")
