...
- `crates/openhuman-core/src/openhuman/security/encryption/` indirectly when secrets sections need at-rest crypto (read direction only).
...
- Hot consumers: `crates/openhuman-core/src/openhuman/agent/` (model + autonomy), `crates/openhuman-core/src/openhuman/channels/` (provider tokens), `crates/openhuman-core/src/openhuman/memory/` (storage paths), `crates/openhuman-core/src/openhuman/cron/` (scheduler poll), `crates/openhuman-core/src/openhuman/inference/local/` (Ollama / device routing), `crates/openhuman-core/src/openhuman/security/` (sandbox backend), `crates/openhuman-core/src/openhuman/voice/`, `crates/openhuman-core/src/openhuman/desktop/notifications/`, `crates/openhuman-core/src/openhuman/tools/`, `crates/openhuman-core/src/openhuman/security/encryption/`, `crates/openhuman-core/src/openhuman/tree_summarizer/`, `crates/openhuman-core/src/openhuman/hosted/referral/`.
