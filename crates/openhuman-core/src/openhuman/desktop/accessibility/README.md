...
- `crates/openhuman-core/src/openhuman/config/` — overlay sizing and helper paths (light dependency).

## Called by

- `crates/openhuman-core/src/openhuman/voice/` — microphone permission and focused-text helpers (indirect, via re-exports).
