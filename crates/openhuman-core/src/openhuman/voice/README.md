...
- `crates/openhuman-core/src/openhuman/desktop_companion/pipeline.rs`, `crates/openhuman-core/src/openhuman/meet/agent/brain.rs`, `crates/openhuman-core/src/openhuman/voice/audio_toolkit/ops.rs`, `crates/openhuman-core/src/openhuman/security/credentials/ops.rs` — call factory / TTS / transcription helpers.
- `crates/openhuman-core/src/openhuman/inference/local/install_piper.rs` — references voice constants/presets.
