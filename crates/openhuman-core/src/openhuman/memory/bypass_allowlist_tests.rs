...
const ALLOWED: &[(&str, &str, &str)] = &[
    ...
    (
        "crates/openhuman-core/src/openhuman/agent/learning/startup.rs",
        "binding::for_workspace(",
    ...
    (
        "crates/openhuman-core/src/openhuman/memory/binding.rs",
        "NullMemoryProvider::new(",
    ...
    (
        "crates/openhuman-core/src/openhuman/memory/guard/families_part_01.rs",
        ".get_document(",
    ...
    (
        "crates/openhuman-core/src/openhuman/memory/ops/guard.rs",
        "binding::for_workspace(",
        "the guarded resolver; this is where the binding becomes a guard",
    ),
    (
        "crates/openhuman-core/src/openhuman/memory/ops/provider.rs",
        ".memory_binding(",
