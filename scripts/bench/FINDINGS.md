...
(`crates/openhuman-core/src/openhuman/memory/agent/memory_loader.rs:218-232` in the pre-change code;
...
(`crates/openhuman-core/src/openhuman/agent/harness/session/turn/core.rs:709`), which
...
The first three are in **`crates/openhuman-core/src/openhuman/`, not the vendored crate**, and reduce
