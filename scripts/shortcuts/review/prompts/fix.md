...
- New Rust functionality under `crates/openhuman-core/src/openhuman/<domain>/`, not root-level `.rs` files.
...
- Capability changes update `crates/openhuman-core/src/openhuman/platform/about_app/`.
