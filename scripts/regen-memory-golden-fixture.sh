...
if ! git diff --quiet -- crates/openhuman-core/src/openhuman/memory; then
  echo "[golden-fixture] WARNING: crates/openhuman-core/src/openhuman/memory has uncommitted changes." >&2
