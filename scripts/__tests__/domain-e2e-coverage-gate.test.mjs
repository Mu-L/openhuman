...
// `process.cwd()`, so a temp dir with `crates/openhuman-core/src/openhuman/**` and `tests/**` is a
...
function fixture(t, options = {}) {
  ...
  if (withExcludedNamespaces) {
    write(
      root,
      'crates/openhuman-core/src/openhuman/test_support/schemas.rs',
    ...
    // controller in.
    write(root, 'crates/openhuman-core/src/openhuman/test_support/mod.rs', 'mod schemas;\n');
    write(
      root,
      'crates/openhuman-core/src/openhuman/mod.rs',
...
test('discovers controllers declared in an include!-split part file', (t) => {
  ...
  write(root, 'crates/openhuman-core/src/openhuman/widgets/schemas_part_01.rs', controller('widgets', 'list'));
...
test('measures a discovered namespace that MODULES does not name', (t) => {
  ...
  write(root, 'crates/openhuman-core/src/openhuman/widgets/schemas_part_01.rs', controller('widgets', 'list'));
  write(root, 'crates/openhuman-core/src/openhuman/widgets/schemas_part_02.rs', controller('widgets', 'purge'));
...
// in between — the arrangement `crates/openhuman-core/src/openhuman/test_support/` actually has.
...
test('resolves the gate for a namespace declared in mod.rs itself', (t) => {
  ...
  write(
    root,
    'crates/openhuman-core/src/openhuman/test_support/mod.rs',
    controller('test', 'reset') + controller('test_support', 'workspace_root'),
  );
  write(root, 'crates/openhuman-core/src/openhuman/mod.rs', '#[cfg(feature = "e2e-test-support")]\npub mod test_support;\n');
  write(root, 'crates/openhuman-core/src/openhuman/widgets/schemas_part_01.rs', controller('widgets', 'list'));
  write(root, 'tests/widgets_e2e.rs', 'let m = "openhuman.widgets_list";');
