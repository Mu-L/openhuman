...
//
// Backend contract (see crates/openhuman-core/src/openhuman/skills/runtime's
// `spawn_workflow_run_background` → preflight branch and
// crates/openhuman-core/src/openhuman/workflows/preflight.rs's `GithubGateError::tag` /
