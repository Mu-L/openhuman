 ...
 * produced by `crates/openhuman-core/src/openhuman/backend_api/*` (`authed_json`, rate limiter,
...
function isThreadNotFoundRpcData(data: unknown): boolean {
  ...
  // crates/openhuman-core/src/openhuman/threads/error.rs THREAD_NOT_FOUND_KIND). The snake_case
