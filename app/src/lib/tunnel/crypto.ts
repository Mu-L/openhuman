 ...
 *
 * Mirrors crates/openhuman-core/src/openhuman/security/devices/crypto.rs — keep in sync.
 */
 ...
 * pair. Mirrors `derive_session_keys` in crates/openhuman-core/src/openhuman/security/devices/crypto.rs:
 *
