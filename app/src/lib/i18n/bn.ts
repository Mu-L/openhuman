...
const messages: TranslationMap = {
  ...
  'mcp.custom.title': 'কাস্টম সার্ভার',
  'mcp.custom.subtitle': 'আপনার নিজের যোগ করা সার্ভার',
  'mcp.custom.addButton': 'যোগ করুন',
  'mcp.custom.empty':
    'এখনও কোনও কাস্টম সার্ভার নেই। রেজিস্ট্রিতে নেই এমন সার্ভারে সংযোগ করতে একটি যোগ করুন।',
  'mcp.custom.edit': 'সম্পাদনা',
  ...
  'mcp.custom.form.editTitle': 'কাস্টম সার্ভার সম্পাদনা করুন',
  'mcp.custom.form.subtitle': 'রেজিস্ট্রিতে নেই এমন সার্ভারে সংযোগ করুন।',
  'mcp.custom.form.name': 'নাম',
  'mcp.custom.form.namePlaceholder': 'আমার ফাইল সার্ভার',
  'mcp.custom.form.transport': 'সংযোগ',
  'mcp.custom.form.transportLocal': 'লোকাল কমান্ড',
  ...
  'mcp.custom.form.argsHint': 'প্রতি লাইনে একটি আর্গুমেন্ট।',
  'mcp.custom.form.url': 'সার্ভার URL',
  'mcp.custom.form.urlPlaceholder': 'https://example.com/mcp',
  'mcp.custom.form.envVars': 'এনভায়রনমেন্ট ভেরিয়েবল',
  'mcp.custom.form.headers': 'রিকোয়েস্ট হেডার',
  'mcp.custom.form.envHint': 'কমান্ড চালু হওয়ার সময় পাঠানো হয়।',
  'mcp.custom.form.headersHint':
    'প্রতিটি রিকোয়েস্টের সঙ্গে পাঠানো হয়। বিয়ারার টোকেনের জন্য Authorization ব্যবহার করুন।',
  'mcp.custom.form.envKeyPlaceholder': 'API_KEY',
  'mcp.custom.form.headerKeyPlaceholder': 'Authorization',
  'mcp.custom.form.envValuePlaceholder': 'মান',
  'mcp.custom.form.envValueForAria': '{key}-এর মান',
  'mcp.custom.form.envRemoveForAria': '{key} সরান',
  'mcp.custom.form.envValueKeepPlaceholder': 'অপরিবর্তিত রাখতে ফাঁকা রাখুন',
  'mcp.custom.form.envKeyAria': 'কী',
  'mcp.custom.form.envValueAria': 'মান',
  'mcp.custom.form.envRemoveAria': 'এই সারি সরান',
  'mcp.custom.form.duplicateKey': '"{key}" দুইবার আছে। একটি সারি সরান।',
  'mcp.custom.form.envAdd': 'সারি যোগ করুন',
  'mcp.custom.form.description': 'বিবরণ',
  'mcp.custom.form.descriptionPlaceholder': 'এই সার্ভার কী করে',
  'mcp.custom.form.save': 'সংরক্ষণ',
  'mcp.custom.form.add': 'সার্ভার যোগ করুন',
  'mcp.custom.form.saving': 'সংরক্ষণ হচ্ছে…',
