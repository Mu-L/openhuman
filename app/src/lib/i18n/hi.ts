...
const messages: TranslationMap = {
  ...
  'mcp.custom.title': 'कस्टम सर्वर',
  'mcp.custom.subtitle': 'आपके द्वारा जोड़े गए सर्वर',
  'mcp.custom.addButton': 'जोड़ें',
  'mcp.custom.empty':
    'अभी कोई कस्टम सर्वर नहीं है। रजिस्ट्री में मौजूद न होने वाले सर्वर से जुड़ने के लिए एक जोड़ें।',
  'mcp.custom.edit': 'संपादित करें',
  ...
  'mcp.custom.form.editTitle': 'कस्टम सर्वर संपादित करें',
  'mcp.custom.form.subtitle': 'ऐसे सर्वर से जुड़ें जो किसी रजिस्ट्री में नहीं है।',
  'mcp.custom.form.name': 'नाम',
  'mcp.custom.form.namePlaceholder': 'मेरा फ़ाइल सर्वर',
  'mcp.custom.form.transport': 'कनेक्शन',
  'mcp.custom.form.transportLocal': 'लोकल कमांड',
  'mcp.custom.form.transportRemote': 'रिमोट URL',
  'mcp.custom.form.transportLocalHint':
    'इस कंप्यूटर पर कमांड चलाता है और stdio के ज़रिए संवाद करता है।',
  'mcp.custom.form.transportRemoteHint': 'HTTP या HTTPS के ज़रिए एंडपॉइंट से जुड़ता है।',
  'mcp.custom.form.command': 'कमांड',
  'mcp.custom.form.commandPlaceholder': 'npx',
  'mcp.custom.form.args': 'आर्ग्युमेंट',
  'mcp.custom.form.argsPlaceholder': '-y\n@scope/my-server',
  'mcp.custom.form.argsHint': 'हर पंक्ति में एक आर्ग्युमेंट।',
  'mcp.custom.form.url': 'सर्वर URL',
  'mcp.custom.form.urlPlaceholder': 'https://example.com/mcp',
  'mcp.custom.form.envVars': 'एनवायरनमेंट वेरिएबल',
  'mcp.custom.form.headers': 'रिक्वेस्ट हेडर',
  'mcp.custom.form.envHint': 'कमांड शुरू होने पर पास किए जाते हैं।',
  'mcp.custom.form.headersHint':
    'हर रिक्वेस्ट के साथ भेजे जाते हैं। बियरर टोकन के लिए Authorization का उपयोग करें।',
  'mcp.custom.form.envKeyPlaceholder': 'API_KEY',
  'mcp.custom.form.headerKeyPlaceholder': 'Authorization',
  'mcp.custom.form.envValuePlaceholder': 'मान',
  'mcp.custom.form.envValueForAria': '{key} का मान',
  'mcp.custom.form.envRemoveForAria': '{key} हटाएं',
  'mcp.custom.form.envValueKeepPlaceholder': 'बनाए रखने के लिए खाली छोड़ें',
  'mcp.custom.form.envKeyAria': 'की',
  'mcp.custom.form.envValueAria': 'मान',
  'mcp.custom.form.envRemoveAria': 'यह पंक्ति हटाएं',
  'mcp.custom.form.duplicateKey': '"{key}" दो बार दर्ज है। एक पंक्ति हटाएं।',
  'mcp.custom.form.envAdd': 'पंक्ति जोड़ें',
  'mcp.custom.form.description': 'विवरण',
  'mcp.custom.form.descriptionPlaceholder': 'यह सर्वर क्या करता है',
