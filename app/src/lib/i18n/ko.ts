...
const messages: TranslationMap = {
  ...
  'mcp.custom.title': '커스텀 서버',
  'mcp.custom.subtitle': '직접 추가한 서버',
  'mcp.custom.addButton': '추가',
  'mcp.custom.empty':
    '아직 커스텀 서버가 없습니다. 레지스트리에 없는 서버를 연결하려면 추가하세요.',
  'mcp.custom.edit': '편집',
  ...
  'mcp.custom.form.editTitle': '커스텀 서버 편집',
  'mcp.custom.form.subtitle': '레지스트리에 없는 서버를 연결합니다.',
  'mcp.custom.form.name': '이름',
  'mcp.custom.form.namePlaceholder': '내 파일 서버',
  'mcp.custom.form.transport': '연결 방식',
  ...
  'mcp.custom.form.argsHint': '한 줄에 인자 하나씩 입력하세요.',
  'mcp.custom.form.url': '서버 URL',
  'mcp.custom.form.urlPlaceholder': 'https://example.com/mcp',
  'mcp.custom.form.envVars': '환경 변수',
  'mcp.custom.form.headers': '요청 헤더',
  'mcp.custom.form.envHint': '명령이 시작될 때 전달됩니다.',
  'mcp.custom.form.headersHint':
    '모든 요청에 함께 전송됩니다. 베어러 토큰은 Authorization 헤더를 사용하세요.',
  ...
  'mcp.custom.form.envRemoveAria': '이 행 삭제',
  'mcp.custom.form.duplicateKey': '"{key}"가 두 번 있습니다. 한 행을 삭제하세요.',
  'mcp.custom.form.envAdd': '행 추가',
  'mcp.custom.form.description': '설명',
  'mcp.custom.form.descriptionPlaceholder': '이 서버가 하는 일',
  'mcp.custom.form.save': '저장',
  'mcp.custom.form.add': '서버 추가',
  'mcp.custom.form.saving': '저장 중…',
