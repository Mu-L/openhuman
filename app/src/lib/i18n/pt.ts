...
const messages: TranslationMap = {
  ...
  'mcp.custom.title': 'Servidores personalizados',
  'mcp.custom.subtitle': 'Servidores adicionados por você',
  'mcp.custom.addButton': 'Adicionar',
  'mcp.custom.empty':
    'Ainda não há servidores personalizados. Adicione um para conectar a um servidor que nenhum registro lista.',
  'mcp.custom.edit': 'Editar',
  'mcp.custom.editAria': 'Editar {name}',
  'mcp.custom.remove': 'Remover',
  'mcp.custom.removeAria': 'Remover {name}',
  'mcp.custom.removeConfirm.title': 'Remover {name}?',
  'mcp.custom.removeConfirm.body':
    'Isto exclui permanentemente o servidor e todas as credenciais que você inseriu. Não é possível desfazer.',
  'mcp.custom.removeConfirm.cancel': 'Cancelar',
  'mcp.custom.removeConfirm.confirm': 'Remover',
  'mcp.custom.transport.local': 'Local',
  'mcp.custom.transport.remote': 'Remoto',
  'mcp.custom.form.addTitle': 'Adicionar um servidor personalizado',
  'mcp.custom.form.editTitle': 'Editar servidor personalizado',
  'mcp.custom.form.subtitle': 'Conecte um servidor que nenhum registro lista.',
  'mcp.custom.form.name': 'Nome',
  'mcp.custom.form.namePlaceholder': 'Meu servidor de arquivos',
  'mcp.custom.form.transport': 'Conexão',
  'mcp.custom.form.transportLocal': 'Comando local',
  'mcp.custom.form.transportRemote': 'URL remota',
  'mcp.custom.form.transportLocalHint': 'Executa um comando neste computador e comunica por stdio.',
  'mcp.custom.form.transportRemoteHint': 'Conecta-se a um endpoint via HTTP ou HTTPS.',
  ...
  'mcp.custom.form.argsHint': 'Um argumento por linha.',
  'mcp.custom.form.url': 'URL do servidor',
  'mcp.custom.form.urlPlaceholder': 'https://example.com/mcp',
  'mcp.custom.form.envVars': 'Variáveis de ambiente',
  'mcp.custom.form.headers': 'Cabeçalhos da requisição',
  'mcp.custom.form.envHint': 'Passadas ao comando na inicialização.',
  'mcp.custom.form.headersHint':
    'Enviados em cada requisição. Use Authorization para um token bearer.',
  'mcp.custom.form.envKeyPlaceholder': 'API_KEY',
  'mcp.custom.form.headerKeyPlaceholder': 'Authorization',
  'mcp.custom.form.envValuePlaceholder': 'Valor',
  'mcp.custom.form.envValueForAria': 'Valor de {key}',
  'mcp.custom.form.envRemoveForAria': 'Remover {key}',
  'mcp.custom.form.envValueKeepPlaceholder': 'Deixe em branco para manter',
  'mcp.custom.form.envKeyAria': 'Chave',
  'mcp.custom.form.envValueAria': 'Valor',
  'mcp.custom.form.envRemoveAria': 'Remover esta linha',
  'mcp.custom.form.duplicateKey': '"{key}" aparece duas vezes. Remova uma linha.',
  'mcp.custom.form.envAdd': 'Adicionar linha',
  'mcp.custom.form.description': 'Descrição',
  'mcp.custom.form.descriptionPlaceholder': 'O que este servidor faz',
  'mcp.custom.form.save': 'Salvar',
  'mcp.custom.form.add': 'Adicionar servidor',
  'mcp.custom.form.saving': 'Salvando…',
