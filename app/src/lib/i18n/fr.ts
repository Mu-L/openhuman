...
const messages: TranslationMap = {
  ...
  'mcp.custom.title': 'Serveurs personnalisés',
  'mcp.custom.subtitle': 'Serveurs que vous ajoutez vous-même',
  'mcp.custom.addButton': 'Ajouter',
  'mcp.custom.empty':
    'Aucun serveur personnalisé. Ajoutez-en un pour connecter un serveur absent des registres.',
  'mcp.custom.edit': 'Modifier',
  ...
  'mcp.custom.form.editTitle': 'Modifier le serveur personnalisé',
  'mcp.custom.form.subtitle': 'Connectez un serveur absent des registres.',
  'mcp.custom.form.name': 'Nom',
  'mcp.custom.form.namePlaceholder': 'Mon serveur de fichiers',
  'mcp.custom.form.transport': 'Connexion',
  'mcp.custom.form.transportLocal': 'Commande locale',
  'mcp.custom.form.transportRemote': 'URL distante',
  'mcp.custom.form.transportLocalHint':
    'Exécute une commande sur cet ordinateur et communique via stdio.',
  'mcp.custom.form.transportRemoteHint': 'Se connecte à un point de terminaison via HTTP ou HTTPS.',
  'mcp.custom.form.command': 'Commande',
  'mcp.custom.form.commandPlaceholder': 'npx',
  'mcp.custom.form.args': 'Arguments',
  'mcp.custom.form.argsPlaceholder': '-y\n@scope/my-server',
  'mcp.custom.form.argsHint': 'Un argument par ligne.',
  'mcp.custom.form.url': 'URL du serveur',
  'mcp.custom.form.urlPlaceholder': 'https://example.com/mcp',
  'mcp.custom.form.envVars': 'Variables d’environnement',
  'mcp.custom.form.headers': 'En-têtes de requête',
  'mcp.custom.form.envHint': 'Transmises à la commande à son démarrage.',
  'mcp.custom.form.headersHint':
    'Envoyés à chaque requête. Utilisez Authorization pour un jeton bearer.',
  'mcp.custom.form.envKeyPlaceholder': 'API_KEY',
  'mcp.custom.form.headerKeyPlaceholder': 'Authorization',
  'mcp.custom.form.envValuePlaceholder': 'Valeur',
  'mcp.custom.form.envValueForAria': 'Valeur de {key}',
  'mcp.custom.form.envRemoveForAria': 'Supprimer {key}',
  'mcp.custom.form.envValueKeepPlaceholder': 'Laissez vide pour conserver',
  'mcp.custom.form.envKeyAria': 'Clé',
  'mcp.custom.form.envValueAria': 'Valeur',
  'mcp.custom.form.envRemoveAria': 'Supprimer cette ligne',
  'mcp.custom.form.duplicateKey': '"{key}" figure deux fois. Supprimez une ligne.',
  'mcp.custom.form.envAdd': 'Ajouter une ligne',
  'mcp.custom.form.description': 'Description',
  'mcp.custom.form.descriptionPlaceholder': 'Rôle de ce serveur',
  'mcp.custom.form.save': 'Enregistrer',
  'mcp.custom.form.add': 'Ajouter le serveur',
  'mcp.custom.form.saving': 'Enregistrement…',
