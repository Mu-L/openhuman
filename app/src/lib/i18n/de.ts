...
const messages: TranslationMap = {
  ...
  'mcp.custom.title': 'Eigene Server',
  'mcp.custom.subtitle': 'Selbst hinzugefügte Server',
  'mcp.custom.addButton': 'Hinzufügen',
  'mcp.custom.empty':
    'Noch keine eigenen Server. Füge einen hinzu, um einen Server zu verbinden, der in keiner Registry steht.',
  'mcp.custom.edit': 'Bearbeiten',
  'mcp.custom.editAria': '{name} bearbeiten',
  'mcp.custom.remove': 'Entfernen',
  'mcp.custom.removeAria': '{name} entfernen',
  'mcp.custom.removeConfirm.title': '{name} entfernen?',
  'mcp.custom.removeConfirm.body':
    'Damit werden der Server und alle von dir eingegebenen Zugangsdaten dauerhaft gelöscht. Das lässt sich nicht rückgängig machen.',
  'mcp.custom.removeConfirm.cancel': 'Abbrechen',
  'mcp.custom.removeConfirm.confirm': 'Entfernen',
  'mcp.custom.transport.local': 'Lokal',
  'mcp.custom.transport.remote': 'Remote',
  'mcp.custom.form.addTitle': 'Eigenen Server hinzufügen',
  'mcp.custom.form.editTitle': 'Eigenen Server bearbeiten',
  'mcp.custom.form.subtitle': 'Verbinde einen Server, der in keiner Registry steht.',
  'mcp.custom.form.name': 'Name',
  'mcp.custom.form.namePlaceholder': 'Mein Dateiserver',
  'mcp.custom.form.transport': 'Verbindung',
  'mcp.custom.form.transportLocal': 'Lokaler Befehl',
  ...
  'mcp.custom.form.argsHint': 'Ein Argument pro Zeile.',
  'mcp.custom.form.url': 'Server-URL',
  'mcp.custom.form.urlPlaceholder': 'https://example.com/mcp',
  'mcp.custom.form.envVars': 'Umgebungsvariablen',
  'mcp.custom.form.headers': 'Anfrage-Header',
  'mcp.custom.form.envHint': 'Werden dem Befehl beim Start übergeben.',
  'mcp.custom.form.headersHint':
    'Werden bei jeder Anfrage gesendet. Nutze Authorization für ein Bearer-Token.',
  'mcp.custom.form.envKeyPlaceholder': 'API_KEY',
  'mcp.custom.form.headerKeyPlaceholder': 'Authorization',
  'mcp.custom.form.envValuePlaceholder': 'Wert',
  'mcp.custom.form.envValueForAria': 'Wert für {key}',
  'mcp.custom.form.envRemoveForAria': '{key} entfernen',
  'mcp.custom.form.envValueKeepPlaceholder': 'Leer lassen zum Beibehalten',
  'mcp.custom.form.envKeyAria': 'Schlüssel',
  'mcp.custom.form.envValueAria': 'Wert',
  'mcp.custom.form.envRemoveAria': 'Diese Zeile entfernen',
  'mcp.custom.form.duplicateKey': '"{key}" ist zweimal vorhanden. Entferne eine Zeile.',
  'mcp.custom.form.envAdd': 'Zeile hinzufügen',
  'mcp.custom.form.description': 'Beschreibung',
  'mcp.custom.form.descriptionPlaceholder': 'Wozu dieser Server dient',
