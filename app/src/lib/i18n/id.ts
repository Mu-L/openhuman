...
const messages: TranslationMap = {
  ...
  'mcp.custom.title': 'Server kustom',
  'mcp.custom.subtitle': 'Server yang Anda tambahkan sendiri',
  'mcp.custom.addButton': 'Tambah',
  'mcp.custom.empty':
    'Belum ada server kustom. Tambahkan satu untuk menyambung ke server yang tidak terdaftar di registri mana pun.',
  'mcp.custom.edit': 'Ubah',
  ...
  'mcp.custom.form.editTitle': 'Ubah server kustom',
  'mcp.custom.form.subtitle': 'Sambungkan server yang tidak terdaftar di registri mana pun.',
  'mcp.custom.form.name': 'Nama',
  'mcp.custom.form.namePlaceholder': 'Server berkas saya',
  'mcp.custom.form.transport': 'Koneksi',
  'mcp.custom.form.transportLocal': 'Perintah lokal',
  'mcp.custom.form.transportRemote': 'URL jarak jauh',
  'mcp.custom.form.transportLocalHint':
    'Menjalankan perintah di komputer ini dan berkomunikasi lewat stdio.',
  'mcp.custom.form.transportRemoteHint': 'Menyambung ke endpoint melalui HTTP atau HTTPS.',
  'mcp.custom.form.command': 'Perintah',
  'mcp.custom.form.commandPlaceholder': 'npx',
  'mcp.custom.form.args': 'Argumen',
  'mcp.custom.form.argsPlaceholder': '-y\n@scope/my-server',
  'mcp.custom.form.argsHint': 'Satu argumen per baris.',
  'mcp.custom.form.url': 'URL server',
  'mcp.custom.form.urlPlaceholder': 'https://example.com/mcp',
  'mcp.custom.form.envVars': 'Variabel lingkungan',
  'mcp.custom.form.headers': 'Header permintaan',
  'mcp.custom.form.envHint': 'Diteruskan ke perintah saat dijalankan.',
  'mcp.custom.form.headersHint':
    'Dikirim pada setiap permintaan. Gunakan Authorization untuk token bearer.',
  ...
  'mcp.custom.form.envRemoveAria': 'Hapus baris ini',
  'mcp.custom.form.duplicateKey': '"{key}" tercantum dua kali. Hapus satu baris.',
  'mcp.custom.form.envAdd': 'Tambah baris',
  'mcp.custom.form.description': 'Deskripsi',
  'mcp.custom.form.descriptionPlaceholder': 'Fungsi server ini',
  'mcp.custom.form.save': 'Simpan',
  'mcp.custom.form.add': 'Tambah server',
  'mcp.custom.form.saving': 'Menyimpan…',
