...
const messages: TranslationMap = {
  ...
  // MCP — custom (hand-added) servers
  'mcp.custom.title': 'Server personalizzati',
  'mcp.custom.subtitle': 'Server aggiunti da te',
  'mcp.custom.addButton': 'Aggiungi',
  'mcp.custom.empty':
    'Nessun server personalizzato. Aggiungine uno per collegare un server assente dai registri.',
  'mcp.custom.edit': 'Modifica',
  'mcp.custom.editAria': 'Modifica {name}',
  'mcp.custom.remove': 'Rimuovi',
  'mcp.custom.removeAria': 'Rimuovi {name}',
  'mcp.custom.removeConfirm.title': 'Rimuovere {name}?',
  'mcp.custom.removeConfirm.body':
    'Questa operazione elimina definitivamente il server e tutte le credenziali che hai inserito. Non è reversibile.',
  'mcp.custom.removeConfirm.cancel': 'Annulla',
  'mcp.custom.removeConfirm.confirm': 'Rimuovi',
  'mcp.custom.transport.local': 'Locale',
  'mcp.custom.transport.remote': 'Remoto',
  'mcp.custom.form.addTitle': 'Aggiungi un server personalizzato',
  'mcp.custom.form.editTitle': 'Modifica server personalizzato',
  'mcp.custom.form.subtitle': 'Collega un server assente dai registri.',
  'mcp.custom.form.name': 'Nome',
  'mcp.custom.form.namePlaceholder': 'Il mio server di file',
  'mcp.custom.form.transport': 'Connessione',
  'mcp.custom.form.transportLocal': 'Comando locale',
  'mcp.custom.form.transportRemote': 'URL remoto',
  'mcp.custom.form.transportLocalHint':
    'Esegue un comando su questo computer e comunica tramite stdio.',
  'mcp.custom.form.transportRemoteHint': 'Si collega a un endpoint tramite HTTP o HTTPS.',
  'mcp.custom.form.command': 'Comando',
  'mcp.custom.form.commandPlaceholder': 'npx',
  'mcp.custom.form.args': 'Argomenti',
  'mcp.custom.form.argsPlaceholder': '-y\n@scope/my-server',
  'mcp.custom.form.argsHint': 'Un argomento per riga.',
  'mcp.custom.form.url': 'URL del server',
  'mcp.custom.form.urlPlaceholder': 'https://example.com/mcp',
  'mcp.custom.form.envVars': 'Variabili d’ambiente',
  'mcp.custom.form.headers': 'Intestazioni della richiesta',
  'mcp.custom.form.envHint': 'Passate al comando all’avvio.',
  'mcp.custom.form.headersHint': 'Inviate a ogni richiesta. Usa Authorization per un token bearer.',
  'mcp.custom.form.envKeyPlaceholder': 'API_KEY',
  'mcp.custom.form.headerKeyPlaceholder': 'Authorization',
  'mcp.custom.form.envValuePlaceholder': 'Valore',
  'mcp.custom.form.envValueForAria': 'Valore di {key}',
  'mcp.custom.form.envRemoveForAria': 'Rimuovi {key}',
  'mcp.custom.form.envValueKeepPlaceholder': 'Lascia vuoto per mantenere',
  'mcp.custom.form.envKeyAria': 'Chiave',
  'mcp.custom.form.envValueAria': 'Valore',
  'mcp.custom.form.envRemoveAria': 'Rimuovi questa riga',
  'mcp.custom.form.duplicateKey': '"{key}" è presente due volte. Rimuovi una riga.',
  'mcp.custom.form.envAdd': 'Aggiungi riga',
  'mcp.custom.form.description': 'Descrizione',
  'mcp.custom.form.descriptionPlaceholder': 'Cosa fa questo server',
  'mcp.custom.form.save': 'Salva',
  'mcp.custom.form.add': 'Aggiungi server',
  'mcp.custom.form.saving': 'Salvataggio…',
