...
const messages: TranslationMap = {
  ...
  'mcp.custom.subtitle': 'Servidores que añades tú mismo',
  'mcp.custom.addButton': 'Añadir',
  'mcp.custom.empty':
    'Aún no hay servidores personalizados. Añade uno para conectar un servidor que no aparece en ningún registro.',
  'mcp.custom.edit': 'Editar',
  'mcp.custom.editAria': 'Editar {name}',
  'mcp.custom.remove': 'Quitar',
  'mcp.custom.removeAria': 'Quitar {name}',
  'mcp.custom.removeConfirm.title': '¿Quitar {name}?',
  'mcp.custom.removeConfirm.body':
    'Esto elimina de forma permanente el servidor y todas las credenciales que introdujiste. No se puede deshacer.',
  'mcp.custom.removeConfirm.cancel': 'Cancelar',
  'mcp.custom.removeConfirm.confirm': 'Quitar',
  'mcp.custom.transport.local': 'Local',
  'mcp.custom.transport.remote': 'Remoto',
  'mcp.custom.form.addTitle': 'Añadir un servidor personalizado',
  'mcp.custom.form.editTitle': 'Editar servidor personalizado',
  'mcp.custom.form.subtitle': 'Conecta un servidor que no aparece en ningún registro.',
  'mcp.custom.form.name': 'Nombre',
  'mcp.custom.form.namePlaceholder': 'Mi servidor de archivos',
  'mcp.custom.form.transport': 'Conexión',
  ...
  'mcp.custom.form.argsHint': 'Un argumento por línea.',
  'mcp.custom.form.url': 'URL del servidor',
  'mcp.custom.form.urlPlaceholder': 'https://example.com/mcp',
  'mcp.custom.form.envVars': 'Variables de entorno',
  'mcp.custom.form.headers': 'Cabeceras de la petición',
  'mcp.custom.form.envHint': 'Se pasan al comando al iniciarse.',
  'mcp.custom.form.headersHint':
    'Se envían con cada petición. Usa Authorization para un token bearer.',
  ...
  'mcp.custom.form.envRemoveForAria': 'Quitar {key}',
  'mcp.custom.form.envValueKeepPlaceholder': 'Déjalo vacío para conservarlo',
  'mcp.custom.form.envKeyAria': 'Clave',
  'mcp.custom.form.envValueAria': 'Valor',
  'mcp.custom.form.envRemoveAria': 'Quitar esta fila',
  'mcp.custom.form.duplicateKey': '"{key}" aparece dos veces. Quita una fila.',
  'mcp.custom.form.envAdd': 'Añadir fila',
  'mcp.custom.form.description': 'Descripción',
  'mcp.custom.form.descriptionPlaceholder': 'Qué hace este servidor',
