...
const messages: TranslationMap = {
  ...
  'mcp.custom.title': 'خوادم مخصصة',
  'mcp.custom.subtitle': 'خوادم تضيفها بنفسك',
  'mcp.custom.addButton': 'إضافة',
  'mcp.custom.empty': 'لا توجد خوادم مخصصة بعد. أضف خادمًا للاتصال بخادم غير مدرج في أي سجل.',
  'mcp.custom.edit': 'تحرير',
  ...
  'mcp.custom.form.editTitle': 'تحرير الخادم المخصص',
  'mcp.custom.form.subtitle': 'اتصل بخادم غير مدرج في أي سجل.',
  'mcp.custom.form.name': 'الاسم',
  'mcp.custom.form.namePlaceholder': 'خادم الملفات الخاص بي',
  'mcp.custom.form.transport': 'الاتصال',
  ...
  'mcp.custom.form.argsHint': 'وسيطة واحدة في كل سطر.',
  'mcp.custom.form.url': 'رابط الخادم',
  'mcp.custom.form.urlPlaceholder': 'https://example.com/mcp',
  'mcp.custom.form.envVars': 'متغيرات البيئة',
  'mcp.custom.form.headers': 'ترويسات الطلب',
  'mcp.custom.form.envHint': 'تُمرَّر إلى الأمر عند بدء تشغيله.',
  'mcp.custom.form.headersHint': 'تُرسل مع كل طلب. استخدم Authorization لرمز حامل.',
  ...
  'mcp.custom.form.envRemoveAria': 'إزالة هذا الصف',
  'mcp.custom.form.duplicateKey': '"{key}" مُدرج مرتين. احذف أحد الصفوف.',
  'mcp.custom.form.envAdd': 'إضافة صف',
  'mcp.custom.form.description': 'الوصف',
  'mcp.custom.form.descriptionPlaceholder': 'ما الذي يفعله هذا الخادم',
  'mcp.custom.form.save': 'حفظ',
  'mcp.custom.form.add': 'إضافة خادم',
  'mcp.custom.form.saving': 'جارٍ الحفظ…',
