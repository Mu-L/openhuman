...
const messages: TranslationMap = {
  ...
  'mcp.custom.title': '自定义服务器',
  'mcp.custom.subtitle': '你自行添加的服务器',
  'mcp.custom.addButton': '添加',
  'mcp.custom.empty': '暂无自定义服务器。添加一个即可连接注册表中没有的服务器。',
  'mcp.custom.edit': '编辑',
  'mcp.custom.editAria': '编辑 {name}',
  'mcp.custom.remove': '移除',
  'mcp.custom.removeAria': '移除 {name}',
  'mcp.custom.removeConfirm.title': '移除 {name}？',
  'mcp.custom.removeConfirm.body': '这将永久删除该服务器以及你为它输入的所有凭据，且无法恢复。',
  'mcp.custom.removeConfirm.cancel': '取消',
  'mcp.custom.removeConfirm.confirm': '移除',
  'mcp.custom.transport.local': '本地',
  'mcp.custom.transport.remote': '远程',
  'mcp.custom.form.addTitle': '添加自定义服务器',
  'mcp.custom.form.editTitle': '编辑自定义服务器',
  'mcp.custom.form.subtitle': '连接注册表中没有的服务器。',
  'mcp.custom.form.name': '名称',
  'mcp.custom.form.namePlaceholder': '我的文件服务器',
  'mcp.custom.form.transport': '连接方式',
  ...
  'mcp.custom.form.argsHint': '每行一个参数。',
  'mcp.custom.form.url': '服务器 URL',
  'mcp.custom.form.urlPlaceholder': 'https://example.com/mcp',
  'mcp.custom.form.envVars': '环境变量',
  'mcp.custom.form.headers': '请求头',
  'mcp.custom.form.envHint': '在命令启动时传入。',
  'mcp.custom.form.headersHint': '随每个请求发送。Bearer 令牌请使用 Authorization。',
  ...
  'mcp.custom.form.envRemoveAria': '移除此行',
  'mcp.custom.form.duplicateKey': '"{key}" 重复了两次。请删除其中一行。',
  'mcp.custom.form.envAdd': '添加一行',
  'mcp.custom.form.description': '描述',
  'mcp.custom.form.descriptionPlaceholder': '该服务器的用途',
  'mcp.custom.form.save': '保存',
  'mcp.custom.form.add': '添加服务器',
  'mcp.custom.form.saving': '正在保存…',
