...
const messages: TranslationMap = {
  ...
  'mcp.custom.title': 'Свои серверы',
  'mcp.custom.subtitle': 'Серверы, добавленные вручную',
  'mcp.custom.addButton': 'Добавить',
  'mcp.custom.empty': 'Своих серверов пока нет. Добавьте сервер, которого нет ни в одном реестре.',
  'mcp.custom.edit': 'Изменить',
  'mcp.custom.editAria': 'Изменить {name}',
  'mcp.custom.remove': 'Удалить',
  'mcp.custom.removeAria': 'Удалить {name}',
  'mcp.custom.removeConfirm.title': 'Удалить {name}?',
  'mcp.custom.removeConfirm.body':
    'Сервер и все введённые вами учётные данные будут удалены безвозвратно. Отменить это действие нельзя.',
  'mcp.custom.removeConfirm.cancel': 'Отмена',
  'mcp.custom.removeConfirm.confirm': 'Удалить',
  'mcp.custom.transport.local': 'Локальный',
  'mcp.custom.transport.remote': 'Удалённый',
  'mcp.custom.form.addTitle': 'Добавить свой сервер',
  'mcp.custom.form.editTitle': 'Изменить свой сервер',
  'mcp.custom.form.subtitle': 'Подключите сервер, которого нет ни в одном реестре.',
  'mcp.custom.form.name': 'Название',
  'mcp.custom.form.namePlaceholder': 'Мой файловый сервер',
  'mcp.custom.form.transport': 'Подключение',
  'mcp.custom.form.transportLocal': 'Локальная команда',
  ...
  'mcp.custom.form.argsHint': 'По одному аргументу в строке.',
  'mcp.custom.form.url': 'URL сервера',
  'mcp.custom.form.urlPlaceholder': 'https://example.com/mcp',
  'mcp.custom.form.envVars': 'Переменные окружения',
  'mcp.custom.form.headers': 'Заголовки запроса',
  'mcp.custom.form.envHint': 'Передаются команде при запуске.',
  'mcp.custom.form.headersHint':
    'Отправляются с каждым запросом. Для bearer-токена используйте Authorization.',
  'mcp.custom.form.envKeyPlaceholder': 'API_KEY',
  'mcp.custom.form.headerKeyPlaceholder': 'Authorization',
  'mcp.custom.form.envValuePlaceholder': 'Значение',
  'mcp.custom.form.envValueForAria': 'Значение для {key}',
  'mcp.custom.form.envRemoveForAria': 'Удалить {key}',
  'mcp.custom.form.envValueKeepPlaceholder': 'Оставьте пустым, чтобы сохранить',
  'mcp.custom.form.envKeyAria': 'Ключ',
  'mcp.custom.form.envValueAria': 'Значение',
  'mcp.custom.form.envRemoveAria': 'Удалить эту строку',
  'mcp.custom.form.duplicateKey': '"{key}" указан дважды. Удалите одну строку.',
  'mcp.custom.form.envAdd': 'Добавить строку',
  'mcp.custom.form.description': 'Описание',
  'mcp.custom.form.descriptionPlaceholder': 'Что делает этот сервер',
