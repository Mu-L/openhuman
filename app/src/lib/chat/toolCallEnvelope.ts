 ...
 * (`crates/openhuman-core/src/openhuman/agent/dispatcher.rs`) and the tinyagents bridge's
 * `message_to_native_chat_message` (`crates/openhuman-core/src/openhuman/agent/tinyagents/convert.rs`)
