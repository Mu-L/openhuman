 ...
 * `MemoryContextWindow` enum (`crates/openhuman-core/src/openhuman/config/schema/agent.rs`)
 ...
 * `config.get_client_config` in `crates/openhuman-core/src/openhuman/config/schemas.rs`.
 */
