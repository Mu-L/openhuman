 ...
 * shapes mirror the Rust handlers in `crates/openhuman-core/src/openhuman/memory/tree/read_rpc.rs`
 * and `schemas.rs`.
 *
 ...
 *
 * Wire shape mirrors Rust's [`ChunkRow`](crates/openhuman-core/src/openhuman/memory/tree/read_rpc.rs)
