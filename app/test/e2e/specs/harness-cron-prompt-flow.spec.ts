 ...
 *
 * Actual tool names discovered in crates/openhuman-core/src/openhuman/tools/impl/cron/:
 ...
 * `enabled: true` for agent jobs; see `crates/openhuman-core/src/openhuman/cron/schemas.rs:359`).
