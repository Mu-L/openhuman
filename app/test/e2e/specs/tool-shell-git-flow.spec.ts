 ...
 * loop (see `crates/openhuman-core/src/openhuman/tools/orchestrator_tools.rs`). Driving them via the
 ...
 * unit suite under `crates/openhuman-core/src/openhuman/tools/impl/system/shell.rs` and
 * `crates/openhuman-core/src/openhuman/tools/impl/filesystem/git_operations.rs`.
 *
 ...
 *    `crates/openhuman-core/src/openhuman/tools/impl/filesystem/git_operations_tests.rs`.
 *
...
describe('System tools — Shell + Git (registry, denial envelope, fixture repo)', function () {
  ...
  it('6.2.2 RPC denial envelope is structurally consistent (precondition for restricted-command surfacing)', async () => {
    ...
    // exhaustively in `crates/openhuman-core/src/openhuman/security/policy_tests.rs`. Here we lock
  ...
  it.skip('(future #68) chat tool_calls drive `shell echo hello` end-to-end via mock LLM', () => {
    ...
    // `crates/openhuman-core/src/openhuman/tools/impl/system/shell.rs::tests::shell_executes_allowed_command`
