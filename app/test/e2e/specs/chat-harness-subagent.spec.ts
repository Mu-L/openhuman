 ...
 * (`crates/openhuman-core/src/openhuman/channels/providers/web.rs::pick_target_agent_id`).
 * Its `[subagents] allowlist = [...]` section synthesises one delegated archetype tool
 * per archetype at build time (see
 * `crates/openhuman-core/src/openhuman/tools/orchestrator_tools.rs`). When the LLM calls
