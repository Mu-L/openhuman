 ...
 * `crates/openhuman-core/src/openhuman/tools/impl/browser/` and are agent-internal: they are not
 ...
 * `crates/openhuman-core/src/openhuman/tools/impl/browser/browser_open_tests.rs` and
 * `browser_tests.rs`.
 *
...
describe('System tools — Browser (open URL + automation registry)', () => {
  ...
  it.skip('(future #68) chat tool_calls drive `browser_open https://example.com` via mock LLM', () => {
    ...
    // `crates/openhuman-core/src/openhuman/tools/impl/browser/browser_open_tests.rs::*`.
  });
});
