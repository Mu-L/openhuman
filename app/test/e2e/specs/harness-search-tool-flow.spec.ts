 ...
 *
 * Actual tool names discovered in crates/openhuman-core/src/openhuman/tools/impl/:
...
describe('Harness — Search tool-flow', () => {
  ...
  it('S3.1 — memory_recall: "what did we discuss about project Atlas" → final reply cites recalled content', async function () {
    ...
    // Tool name: "memory_recall" (crates/openhuman-core/src/openhuman/tools/impl/memory/recall.rs)
    const FORCED = [
      {
        content: '',
        toolCalls: [
  ...
  it('S3.2 — web_search_tool: "search for Rust async best practices" → final reply cites results', async function () {
    ...
    // Tool name: "web_search_tool" (crates/openhuman-core/src/openhuman/tools/impl/network/web_search.rs)
  ...
  it('S3.3 — file_read: "read the README" → final reply contains file content phrase', async function () {
    ...
    // Tool name: "file_read" (crates/openhuman-core/src/openhuman/tools/impl/filesystem/file_read.rs)
