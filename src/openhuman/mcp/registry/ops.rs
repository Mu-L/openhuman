...
mod tests {
    ...
    fn collect_required_env_keys_from_schema() {
        use crate::openhuman::mcp::registry::types::{SmitheryConnection, SmitheryServerDetail};
        ...
        let keys = crate::openhuman::mcp::registry::setup_ops::collect_required_env_keys(&detail);
    ...
    fn resolve_command_with_example_config() {
        use crate::openhuman::mcp::registry::types::SmitheryConnection;
